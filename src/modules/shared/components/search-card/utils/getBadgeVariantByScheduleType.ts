...
import { ScheduleType, WeekHoursType } from "../../../configs/searchOptionsConfig";
import { BadgeType } from "../types/BadgeType";

export const getBadgeVariantByScheduleType = (type?: ScheduleType | WeekHoursType): BadgeType => {
  switch (type) {
    case "fullDay": {
      return {
