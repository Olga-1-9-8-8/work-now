...
export const HomeDetails = () => {
  ...
  return (
    <section className="flex flex-col items-center gap-6 pb-8">
      <TypographyH3 className="text-secondary">Если ты Студент или Выпускник</TypographyH3>

      <p className="font-medium text-secondary md:text-lg">
        На сайте есть множество предложений стажировок. Прочти краткую информацию о них
      </p>
