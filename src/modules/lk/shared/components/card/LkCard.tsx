...
import { Card, CardFooter, CardHeader } from "../../../../shared/ui/card/Card";
...
export const LkCard = ({ data }: LkCardProps) => {
    ...
    >
      ...
      <CardFooter className="flex-col justify-between gap-4 pt-4 lg:flex-row">
        <div className="flex w-full flex-row gap-4">
          <FavoriteButton id={data.id} role={data.role!} isInFavorites={data.isInFavorites} />
